...
TRAIN_DATA  = os.path.join(ROOT_DIR, "data", "processed", "biden_train.txt")
DEFAULT_OUT = os.path.join(ROOT_DIR, "models", "biden")
BASE_MODEL  = "gpt2-medium"

def parse_args():
    parser = argparse.ArgumentParser(
        description="Fine-tune GPT-2 Medium on Biden speech data."
    )
...
def train(args):
    ...
    print("=" * 60)
    print("  Biden GPT-2 Medium Fine-Tuning")
    print("=" * 60)
    ...
    print(f"\n  Saving fine-tuned Biden model to  {args.output_dir}  …")
